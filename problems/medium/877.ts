...
// Decide whether Alice wins under the problem's guaranteed game structure.
function stoneGame(piles: number[]): boolean {
  // Alice can reserve the richer index parity, whose unequal sums guarantee her victory.
  return true;
}
